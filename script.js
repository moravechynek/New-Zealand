$(document).ready(function(){
  // historie
  $("#historie1").mouseover(function(){
    $("#historie1").css("background-color", "beige");
    $("#historie1 p").css("font-size", 18);
    $("#historie1 h3").css("font-size", 30);
  });
  $("#historie1").mouseout(function(){
    $("#historie1").css("background-color", "white");
    $("#historie1 p").css("font-size", 16);
    $("#historie1 h3").css("font-size", 28);
  });
  $("#historie2").mouseover(function(){
    $("#historie2").css("background-color", "beige");
    $("#historie2 p").css("font-size", 18);
    $("#historie2 h3").css("font-size", 30);
  });
  $("#historie2").mouseout(function(){
    $("#historie2").css("background-color", "white");
    $("#historie2 p").css("font-size", 16);
    $("#historie2 h3").css("font-size", 28);
  });
  $("#historie3").mouseover(function(){
    $("#historie3").css("background-color", "beige");
    $("#historie3 p").css("font-size", 18);
    $("#historie3 h3").css("font-size", 30);
  });
  $("#historie3").mouseout(function(){
    $("#historie3").css("background-color", "white");
    $("#historie3 p").css("font-size", 16);
    $("#historie3 h3").css("font-size", 28);
  });
  $("#historie4").mouseover(function(){
    $("#historie4").css("background-color", "beige");
    $("#historie4 p").css("font-size", 18);
    $("#historie4 h3").css("font-size", 30);
  });
  $("#historie4").mouseout(function(){
    $("#historie4").css("background-color", "white");
    $("#historie4 p").css("font-size", 16);
    $("#historie4 h3").css("font-size", 28);
  });
  $("#historie5").mouseover(function(){
    $("#historie5").css("background-color", "beige");
    $("#historie5 p").css("font-size", 18);
    $("#historie5 h3").css("font-size", 30);
  });
  $("#historie5").mouseout(function(){
    $("#historie5").css("background-color", "white");
    $("#historie5 p").css("font-size", 16);
    $("#historie5 h3").css("font-size", 28);
  });
  $("#historie6").mouseover(function(){
    $("#historie6").css("background-color", "beige");
    $("#historie6 p").css("font-size", 18);
    $("#historie6 h3").css("font-size", 30);
  });
  $("#historie6").mouseout(function(){
    $("#historie6").css("background-color", "white");
    $("#historie6 p").css("font-size", 16);
    $("#historie6 h3").css("font-size", 28);
  });
  // mapa
